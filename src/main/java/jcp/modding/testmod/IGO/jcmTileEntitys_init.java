...
import static jcp.modding.testmod.util.RegHelper.reg;

public final class jcmTileEntitys_init {

    public static void init() {
        reg(TE_ModTestTE.class, (String) Reference.MOD_ID + "test_tile_entity");
    }
}
